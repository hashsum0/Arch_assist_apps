        ...
        echo -e "\x1B[36m""предворительные настройки нашей будующей системы ""\x1B[0m"
            echo "Продолжить?  y/N"
                read var
                    ...
                    read -s -n1 -p $'\x1B[32m Нажмите любую клавишу чтобы выйти\x1B[0m'   
                    else echo "Пропустили."
                    fi
            }
#********************************************************************************************11-grub_pkg_install
...
function dialog_my {
        ...
        echo -e "\x1B[36m""\t\t\t\t2) Пропустить следующий шаг и перейти к:""\x1B[0m"${stepn[$(($step+2))]}
...
function dialog_my_chroot {
        ...
        echo -e "\x1B[33m""\t\t\t\t_______________________________V______________________________""\x1B[0m"
            ...
            if [ "$var" == "1" ];then
                ...
                echo -e "\x1B[36m""select and enter number item""\x1B[0m"
                echo -e "\x1B[36m""11) Установка пакета загрузчика""\x1B[0m"
                echo -e "\x1B[36m""12) Установка дополнительных пакетов""\x1B[0m"
                echo -e "\x1B[36m""13) Имя машины""\x1B[0m"
                echo -e "\x1B[36m""14) Выбор часового пояса""\x1B[0m"
                echo -e "\x1B[36m""15) Язык системы""\x1B[0m"
                echo -e "\x1B[36m""16) Создаем linux_img""\x1B[0m"
                echo -e "\x1B[36m""17) Обновляем конфигурацию GRUB""\x1B[0m"
                echo -e "\x1B[36m""18) Установка загрузчика""\x1B[0m"
                echo -e "\x1B[36m""19) Создать пороль root""\x1B[0m"
                echo -e "\x1B[33m""______________________________________V_________________________________________________\v\v""\x1B[0m"
                read -s -n1 step
                if [ "$step" == "" ]
                then echo "skip"
